                               ...
                               <?php include('descargar.php'); ?>
                                <form method="POST" class="register__modal-register grid" id="download">
                                    ...
                                    <div class="contact__inputs grid">
                                        ...
                                        <div class="mw100 contact__content">
                                            <label for="email" class="contact__label">
                                                <i class="uil uil-at contact__label"></i>
                                                Correo Electrónico
                                                <input type="email" name="email" class="contact__input" autocomplete="off" placeholder="Ingrese su Correo Electrónico aquí" >
                                            </label>
                                        </div>
                                         <div class="mw100 contact__content">
                                        ...
                                        <div class="mw100 contact__content">
                                            <label for="contact" class="contact__label">
                                                ...
                                                <select name="contact" placeholder="Seleccione una opción" class="contact__input" autocomplete="off">
                ...
                <div>
                    <div class="contact__information">
                        ...
                        <div>
                            ...
                            <span class="contact__subtitle"><a class="contact__subtitle" id="flag" href='https://emojitool.com/flag-for-argentina'>🇦🇷</a> 54-353-6579619</span>
                        </div>
                    </div>
                    ...
                    <div class="contact__information">
                        ...
                        <div>
                            ...
                            <span class="contact__subtitle">info@fabriziodev.ar</span>
                        </div>
                    </div>
                    <div class="contact__information">
                        ...
                        <div>
                            ...
                            <span class="contact__subtitle"><a class="contact__subtitle" id="flags" href='https://emojitool.com/flag-for-argentina'>🇦🇷</a> Villa María - Córdoba, Argentina </span>
                        </div>
                    </div>
                </div>
                <!-- Aquí va el form -->
                
                <form method="POST" enctype="multipart/form-data" class="contact__form grid" id="miForm" autocomplete="ÑÖcompletes">

                
                    <div class="contact__inputs grid">
                        <div class="contact__content">
                            <label for="name" class="contact__label">Nombre</label>
                            <input type="text" class="mayus contact__input" name="name" autocomplete="ÑÖcompletes">
                        </div>
                        <div class="contact__content">
                            <label for="lastname" class="contact__label">Apellido</label>
                            <input type="text" class="mayus contact__input" name="lastname" autocomplete="ÑÖcompletess">
                        </div>
                    </div>
                        ...
                        <div class="contact__content">
                            ...
                            <input type="email" class="contact__input" name="email" autocomplete="ÑÖcompletes">
                        </div>
                        <div class="contact__content">
                            <label for="whatsapp" class="contact__label">Whatsapp</label>
                            <input type="tel" id="whatsapp2" class="contact__input" name="whatsapp" autocomplete="ÑÖcompletes">
                        </div>
                    <div class="contact__content">
                            <label for="subject" class="contact__label">Asunto</label>
                            <input type="text" class="mayus contact__input" name="subject" autocomplete="ÑÖcompletes">
                        </div>
                    <div class="contact__content">
                        <label for="message" class="contact__label">Mensaje</label>
                        <textarea  id="" cols="30" rows="10" class="contact__textarea contact__input" name="message" autocomplete="ÑÖcompletes" maxlength="1000"></textarea>
                    </div>
                    <div>
