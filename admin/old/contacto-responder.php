...
<head>
  ...
  <?php $resultado = mysqli_query($conexion, $datos);
                    ...
                    ?>
  <title>Responder a <?php echo $row["name"]; ?> <?php echo $row["lastname"];?> | Fabrizio Ferroni - Web Developer</title>
  <?php } ?>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <?php $resultado = mysqli_query($conexion, $datos);
                    while($row = mysqli_fetch_assoc($resultado)){
                    ?>
            <h1 class="m-0">Responder a: <?php echo $row["name"];?> <?php echo $row["lastname"];?></h1>
            <?php } ?>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <?php $resultado = mysqli_query($conexion, $datos);
              ...
              <div class="card-body">
                <div class="form-group">              
                  <input type="email" class="form-control" placeholder="Para:" value="<?php echo $row["email"];?>" readonly>                  
                </div>
                <div class="form-group">
                  <input type="text" class="form-control" placeholder="Asunto:" value="<?php echo $row["subject"];?>" readonly>
                </div>
                <div class="form-group">
                    <textarea id="compose-textarea" class="form-control" style="height: 400px">
                      ...
                      <p class=""><b>Asunto: </b><?php echo $row["subject"];?> <br></p>
