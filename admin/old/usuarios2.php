      ...
      <div class="container-fluid">
        ...
        <div class="card card-danger card-outline">
          <div class="card-header">
              ...
              <button class="btn btn-success mibtn2"type="button" data-bs-toggle="modal" data-bs-target="#edituser"><i class="fas fa-pen"></i>  Editar Configuraciónes</button>
          </div>
          <div class="card-body">
              <table id="example" class="display table  table-striped table-hover text-nowrap" style="width:100%">
                ...
                <?php $resultado = mysqli_query($conexion, $datos);
                    ...
                    <tr>
                        ...
                        <?php }else{ ?>  
                         <img src="<?php echo $row["rutaimg"]; ?>" class="img-fluid elevation-2" alt="" width="100px" height="100px">
                         <?php } ?>
                         </td>
