...
$datos3 = "SELECT * FROM users";
$user = $_SESSION['usuario'];
$datos2 = "SELECT * FROM users where usuario ='$user'";;
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <?php $resultado2 = mysqli_query($conexion, $datos2);
            while($row2 = mysqli_fetch_assoc($resultado2)){
            ?>
          <a style="cursor: pointer;" class="d-block"><?php echo $row2["name"];?> <?php echo $row2["lastname"];; ?></a>  
          <?php } mysqli_free_result($resultado2);?> 
      ...
      <div class="container-fluid">
        ...
        <div class="card card-danger card-outline">
          ...
          <table id="example" class="display table  table-striped table-hover text-nowrap" style="width:100%">
                ...
                <tbody>
                <?php $resultado3 = mysqli_query($conexion, $datos3);
                    ...
                    <tr>
                        ...
                        <td>
                        <?php 
                        if($row3["rutaimg"] == null){
                          ?>
                          <img src="dist\img\avatar.png" class="img-fluid elevation-2" alt="" width="100px" height="100px">
                        <?php }else{ ?>  
                         <img src="<?php echo $row3["rutaimg"]; ?>" class="img-fluid elevation-2" alt="" width="100px" height="100px">
                         <?php } ?>
                         </td>
                        ...
                        <td>
                        <button class="btn btn-info"type="button" data-bs-toggle="modal" data-bs-target="#edituser<?php echo $row3["id"];?>"><i class="fas fa-pen"></i></button>
                        
                        <!-- <a class="btn btn-danger delete" data-bs-toggle="tooltip" data-placement="top" title="Borrar" id="delete"><i class="fas fa-trash"></i></a> -->
                        <button class="btn btn-danger" onclick="AlertarEliminacion(<?php echo $row3["id"] ?>);"><i class="fas fa-trash"></i></button>
                        ...
                        <div class="modal fade " id="edituser<?php echo $row3["id"];?>" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">

  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel"><i class="fas fa-pen"></i> Editar Usuario: <?php echo $row3["usuario"]; ?></h5>
      ...
      <div class="modal-body">
        <form method="POST" enctype="multipart/form-data" id="form1">
              ...
              <div class="row">
                <div class="col-md-12">
                <?php if($row3["rutaimg"] == null){
                          ?>
                   <img src="dist\img\avatar.png" class="img-circle elevation-2" alt="" width="100px" height="100px">
                        <?php }else{ ?>  
                  <img src="<?php echo $row3["rutaimg"]; ?>" alt="" class="img-circle elevation-2" width="150px">
                  <?php } ?>
                </div>             
              </div>
              ...
              <div class="col-md-12">
                ...
                <input type="hidden" name="id" value="<?php echo $row3["id"]; ?>">
                    <div class="col-md-12">
                      ...
                      <input type="text" name="name" class="form-control" value="<?php echo $row3["name"]; ?>" autocomplete="off">
                    </div>
                  </div>
                  <div class="row mtop16">
                    <div class="col-md-12">
                      <label for="host"> Apellido</label>
                      <input type="text" name="host" class="form-control" value="<?php echo $row3["lastname"]; ?>" autocomplete="off">
                    </div>
                  </div>
                  <div class="row mtop16">
                    <div class="col-md-12">
                      <label for="port"> Email</label>
                      <input type="text" name="port" class="form-control" value="<?php echo $row3["email"]; ?>"  autocomplete="off">
                    </div>                    
                  </div>
                  ...
                  <div class="row mtop16">
                      <div class="col-md-12">
                        ...
                        <input type="text" name="smtpsecure" class="form-control" value="<?php echo $row3["usuario"]; ?>" autocomplete="off">
                      </div>
                  </div>
                  <div class="row mtop16">
                    <div class="col-md-12">
                      <label for="username">Contraseña Actual</label>
                      <input type="password" name="username" class="form-control" value="<?php echo $row3["contraseña"]; ?>" autocomplete="off">
                    </div>
                  </div>
                  <div class="row mtop16">
                    <div class="col-md-12">
                      <label for="username">Nueva Contraseña</label>
                      <input type="password" name="username" class="form-control"  autocomplete="off">
                    </div>
                  </div>
                  <div class="row mtop16">
                    <div class="col-md-12">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-success" onclick="onSubmitForm(<?php echo $row3["id"] ?>);"><i class="fas fa-save"></i> Guardar</button>
